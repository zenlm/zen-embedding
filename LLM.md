# zen-embedding — AI Knowledge Base

**Project**: zen-embedding
**Organization**: zenlm
**Repository**: https://github.com/zenlm/zen-embedding
**HuggingFace**: https://huggingface.co/zenlm/zen-embedding
**Last Updated**: 2026-02-27

## Overview

zen-embedding is part of the Zen AI model family by Hanzo AI / Zen LM.
